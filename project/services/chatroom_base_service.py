# project/services/chatroom_base_service.py
"""
聊天室基础服务类 - 消除重复代码
"""
import logging
...
from project.utils.optimization.performance_monitor import monitor_performance
from project.config.chatroom_config import CACHE_CONFIG, POINTS_CONFIG
            ...
            async def wrapper(*args, **kwargs):
                ...
                try:
                    ...
                    if invalidate_cache and room_id:
                        from project.utils.optimization.performance_monitor import CacheOptimizer
