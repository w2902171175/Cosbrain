...
本文档详细描述了学生项目协作平台的数据库表结构，共包含 **27个数据表**。
...
| total_points | Integer | Default=0, Not Null | 用户当前总积分 |
| last_login_at | DateTime | Nullable | 用户上次登录时间（用于每日打卡） |
| login_count | Integer | Default=0, Not Null | 用户总登录天数（完成每日打卡的次数） |
